...
if __name__ == "__main__":
    ...
    for r, roi in enumerate(rois):
        ...
        dataset = rsa.data.Dataset(
            ...
            obs_descriptors={'cue': cue,
                             ...
                             'stimFinger,cue': [sf + ',' + c for sf, c in zip(stimFinger, cue)],
                             'epoch': epoch,
                             'instr': instr,
                             'run': run})
        ...
        # euclidean distance
        rdm_eucl.append(rsa.rdm.calc_rdm_unbalanced(dataset, method='euclidean', descriptor='stimFinger,cue'))
    ...
    descr = json.dumps({
        ...
        'pattern_descriptors': {'stimFinger,cue':
                                    list(rdm_eucl[0].pattern_descriptors['stimFinger,cue'])}
    })
