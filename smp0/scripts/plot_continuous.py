...
from smp0.utils import load_npy, pool_participants, Z_condition
from smp0.visual import plot_response_continuous
...
if __name__ == "__main__":
    ...
    clamped_Z = Z_condition(clamped_d.stimFinger)
    ...
    if len(sys.argv) == 4:
        ...
        data_pooled = pool_participants(experiment,
                                        ...
                                        channels_names,
                                        datatype)
        plot_response_continuous(data_pooled, clamped_mean, datatype=datatype)
